...
class CFrontendSetup {
	...
	const MIN_PHP_MEMORY_LIMIT = '3342177280'; // 128 * ZBX_MEBIBYTE;
	const MIN_PHP_POST_MAX_SIZE = '367772160'; // 16 * ZBX_MEBIBYTE;
	const MIN_PHP_UPLOAD_MAX_FILESIZE = '50971520'; // 2 * ZBX_MEBIBYTE;
